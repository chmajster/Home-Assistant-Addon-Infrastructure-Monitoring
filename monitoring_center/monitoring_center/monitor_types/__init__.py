...
PRESETS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "interval_seconds": 60,
        "config": {"host": "192.168.1.40", "port": 8123, "timeout_seconds": 5},
    },
    {
        "name": "NAS - ping",
        "type": "ping_host",
    ...
    },
    {
        ...
        "interval_seconds": 60,
        "config": {"host": "192.168.1.50", "port": 445, "timeout_seconds": 5},
    },
    {
        ...
        "interval_seconds": 60,
        "config": {"host": "192.168.1.10", "port": 22, "timeout_seconds": 5},
    },
    {
        ...
        "config": {"expected_status_codes": [200], "timeout_seconds": 10, "max_page_size_kb": 512},
    },
    {
    ...
    },
    {
        ...
        "target": "example.com",
        "interval_seconds": 300,
        "config": {"record_type": "A", "timeout_seconds": 5},
    },
]
