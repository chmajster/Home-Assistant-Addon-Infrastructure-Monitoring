...
PRESETS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "interval_seconds": 60,
        "config": {"host": "192.168.1.40", "port": 8123, "timeout_minutes": 0.0833},
    },
    {
        "name": "NAS - ping",
        "type": "ping_host",
    ...
    },
    {
        ...
        "interval_seconds": 60,
        "config": {"host": "192.168.1.50", "port": 445, "timeout_minutes": 0.0833},
    },
    {
        ...
        "interval_seconds": 60,
        "config": {"host": "192.168.1.10", "port": 22, "timeout_minutes": 0.0833},
    },
    {
        ...
        "config": {"expected_status_codes": [200], "timeout_minutes": 5, "max_page_size_mb": 5},
    },
    {
    ...
    },
    {
        ...
        "target": "example.com",
        "interval_seconds": 300,
        "config": {"record_type": "A", "timeout_minutes": 0.0833},
    },
]
